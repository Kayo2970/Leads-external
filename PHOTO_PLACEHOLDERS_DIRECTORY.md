...
| **ph59** | Event Gallery Photo 3 | Student Leadership Panel | `/events` | `GalleryGrid` | `/images/gallery/g3.webp` |
| **ph60** | Event Gallery Photo 4 | Delegation Networking | `/events` | `GalleryGrid` | `/images/gallery/g4.webp` |
| **ph61** | Event Gallery Photo 5 | Founders Pitch Session | `/events` | `GalleryGrid` | `/images/gallery/g5.webp` |
| **ph62** | Event Gallery Photo 6 | Award Ceremony | `/events` | `GalleryGrid` | `/images/gallery/g6.webp` |
| **ph63** | Event Gallery Photo 7 | Roundtable Session | `/events` | `GalleryGrid` | `/images/gallery/g7.webp` |
| **ph64** | Event Gallery Photo 8 | Campus Delegation | `/events` | `GalleryGrid` | `/images/gallery/g8.webp` |
| **ph65** | Event Gallery Photo 9 | FDP Masterclass | `/events` | `GalleryGrid` | `/images/gallery/g9.webp` |
