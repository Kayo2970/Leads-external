...
export const EVENTS_DATA: LEADSEvent[] = [
  ...
  {
    id: "inauguration-annual-day",
    name: "LEADS Inauguration Function & Annual Day",
    seriesName: "LEADS Annual Celebration",
    category: "Conclave",
    tagline: "Celebrating Institutional Excellence, Leadership Legacy & the Spirit of LEADS",
    date: "Annual Flagship · April 2026",
    location: "RUAS University House, Mathikere Campus, Bengaluru",
    attendees: "800+ Faculty, Students, Alumni & Dignitaries",
    badgeColor: "bg-[#9C1256]/20 text-white border-[#DE3F11]/40",
    logoSvg: "star",
    ...
    featured: true,
    description:
      "The LEADS Inauguration Function & Annual Day is the Centre's most celebrated institutional gathering — a landmark event that honours the founding vision of LEADS Next Gen Centre, recognises outstanding student and faculty contributions, unveils the Centre's annual impact report, and formally welcomes the incoming leadership cohort. The event brings together RUAS chancellors, FMC deans, industry mentors, alumni trailblazers, and current members for an evening of ceremony, reflection, and inspiration.",
    seriesHighlights: [
      "Formal lamp-lighting ceremony and institutional address by the Vice-Chancellor",
      "Annual LEADS Impact & Achievement Report unveiling",
      "LEADS Excellence Awards honouring top performers across all cohorts",
      "Cultural showcase, alumni keynotes & incoming council oath-taking ceremony",
    ],
    outcomes: [
    ...
    speakers: [
      ...
      "Invited Industry Dignitaries & Mentors",
    ],
    editions: [
      {
