...
export const EVENTS_DATA: LEADSEvent[] = [
  ...
  },
  {
    ...
    logoSvg: "users",
    photo: "/events/International Workshop Mindful Leadership and Well-Being in HEIs.jpg",
    gallery: ["/events/International Workshop Mindful Leadership and Well-Being in HEIs.jpg"],
    featured: false,
