        ...
        <div className="py-6 border-b border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-[#E1306C]/50 hover:bg-[#E1306C]/10 transition-all duration-300"
            >
              ...
              <span className="text-xs font-semibold text-white/80 group-hover:text-white">@leads_next_gen_ruas</span>
            </a>
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-[#0A66C2]/50 hover:bg-[#0A66C2]/10 transition-all duration-300"
            >
              <svg className="w-4 h-4 text-[#0A66C2] group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-[#25D366]/50 hover:bg-[#25D366]/10 transition-all duration-300"
            >
              <svg className="w-4 h-4 text-[#25D366] group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <span className="text-xs font-semibold text-white/80 group-hover:text-white">+91 891 013 3283</span>
            </a>
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:border-[#DE3F11]/50 hover:bg-[#DE3F11]/10 transition-all duration-300"
            >
              <Mail className="w-4 h-4 text-[#DE3F11] group-hover:scale-110 transition-transform" />
