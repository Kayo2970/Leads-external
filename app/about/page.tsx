...
import { Shield, Target, BookOpen, Award, Building2 } from "lucide-react";
  ...
  return (
    <div className="pt-28 pb-24 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-14 flex justify-center">
        <div className="bg-white/95 p-4 sm:p-6 rounded-3xl border border-[#DE3F11]/40 shadow-xl inline-block max-w-2xl text-center hover:scale-[1.02] transition-transform duration-300">
          <img
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Story Card */}
          <div className="glass-panel p-8 rounded-3xl border border-[#9C1256]/30 shadow-xl space-y-4">
          ...
          {/* Mission Card */}
          <div className="glass-panel p-8 rounded-3xl border border-[#DE3F11]/40 shadow-xl space-y-4">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#9C1256] to-[#DE3F11] text-white flex items-center justify-center shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="glass-panel rounded-3xl p-8 sm:p-12 border border-[#9C1256]/30 text-center relative overflow-hidden">
          <div className="w-16 h-16 rounded-2xl bg-[#241147] border border-[#DE3F11]/40 text-[#DE3F11] flex items-center justify-center mx-auto mb-6 shadow-md">
