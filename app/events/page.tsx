        ...
        {filteredEvents.map((event, index) => {
          ...
          if (isLightCard) {
            return (
              <div
                key={event.id}
                className="rounded-3xl p-6 sm:p-10 border border-purple-100 shadow-2xl hover:border-[#DE3F11]/50 transition-all duration-300 relative overflow-hidden group bg-white text-[#1E0C3D]"
              >
          ...
          return (
            <div
              key={event.id}
              className="glass-panel rounded-3xl p-6 sm:p-10 border border-[#9C1256]/30 shadow-2xl hover:border-[#DE3F11]/50 transition-all duration-300 relative overflow-hidden group bg-[#2A1454]/90 text-white"
            >
