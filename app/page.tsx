...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-28 pb-20 overflow-hidden bg-gradient-to-b from-transparent via-[#2A1454]/40 to-transparent">
      ...
      <section className="relative z-10 py-12 border-y border-white/15 glass-panel">
      ...
      {/* WHO IT'S FOR */}
      <section className="py-20 bg-[#241147]/50 border-y border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-extrabold text-white">
              Built for Every Leader Across India
            </h2>
            <p className="text-sm text-[#E2D9F3] mt-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="glass-panel p-6 rounded-3xl border border-white/15 hover:border-[#DE3F11]/60 transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-[#9C1256]/20 to-[#DE3F11]/20 border border-[#DE3F11]/30 text-white flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <Building2 className="w-6 h-6 text-[#DE3F11]" />
              </div>
              <h3 className="font-bold text-white mb-2">Government & Policy</h3>
            ...
            <div className="glass-panel p-6 rounded-3xl border border-white/15 hover:border-[#DE3F11]/60 transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-[#9C1256]/20 to-[#DE3F11]/20 border border-[#DE3F11]/30 text-white flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <Briefcase className="w-6 h-6 text-[#DE3F11]" />
              </div>
              <h3 className="font-bold text-white mb-2">Industry Leaders</h3>
              <p className="text-xs text-[#E2D9F3] leading-relaxed">
            ...
            <div className="glass-panel p-6 rounded-3xl border border-white/15 hover:border-[#DE3F11]/60 transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-[#9C1256]/20 to-[#DE3F11]/20 border border-[#DE3F11]/30 text-white flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <TrendingUp className="w-6 h-6 text-[#DE3F11]" />
              </div>
            ...
            <div className="glass-panel p-6 rounded-3xl border border-white/15 hover:border-[#DE3F11]/60 transition-all group">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-[#9C1256]/20 to-[#DE3F11]/20 border border-[#DE3F11]/30 text-white flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <GraduationCap className="w-6 h-6 text-[#DE3F11]" />
              </div>
              <h3 className="font-bold text-white mb-2">Students & Scholars</h3>
              <p className="text-xs text-[#E2D9F3] leading-relaxed">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto rounded-3xl bg-gradient-to-r from-[#241147] via-[#361C6A] to-[#241147] p-8 sm:p-12 border border-[#DE3F11]/40 shadow-2xl text-center relative overflow-hidden">
